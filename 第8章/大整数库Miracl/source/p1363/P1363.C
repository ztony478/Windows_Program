 ...
 *
 * Copyright (c) 2000-2002 Shamus Software Ltd.
 */
...
/* NOTE ripemd is not implemented and the last 3 IDs are invented! */

static unsigned char sha_id[]={0x33,0x31,0x3a,0x3b,0x3c};
